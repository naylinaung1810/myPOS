    ...
    <main>
        <div class="row">
            <div class="col s6" style="padding-top: 15px">
                ...
                <span style="margin-left: 10px;font-size: 30px">Income </span><span>> {{$shop->city}} </span>
            </div>
            <div class="col s6">
        ...
        <section style="margin-top: 0px;margin-right: 10px">
            <input id="shop_id" type="hidden" name="{{$shop->id}}" value="{{$shop->id}}">
            <div class="row">
                <div class="col s12">
